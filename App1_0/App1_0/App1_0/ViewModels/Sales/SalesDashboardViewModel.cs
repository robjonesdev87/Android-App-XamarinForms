...
// ***********************************************************************
// <copyright file="SalesDashboardViewModel.cs" company="App1_0">
...
namespace App1_0.ViewModels.Sales
{
    ...
    public class SalesDashboardViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Gets or sets the sales dashboard view model.
        /// </summary>
        /// <value>The sales dashboard view model.</value>
        public SalesDashboardViewModel salesDashboardViewModel { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesDashboardViewModel"/> class.
        /// </summary>
